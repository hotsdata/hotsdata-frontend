...
class BattlefieldOfEternity extends React.Component {
  constructor(props) {
    super(props)
  ...
  createStatsRow(playerInfo, playerStats) {
    ...
    return (
      <tr key={playerStats.playerId} className={(isWinner ? 'victory-row' : 'defeat-row')}>
        ...
        <td>{playerStats.DamageDoneToImmortal}</td>
      </tr>
    )
  }
...
export default BattlefieldOfEternity;
